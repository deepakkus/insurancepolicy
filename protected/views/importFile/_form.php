...
?>
    ...
    <div class="clearfix formContainer">
        ...
        <div class="fluidField">
            <?php
            echo $form->labelEx($importFile,'type');
            echo $form->dropDownList($importFile,'type', $importFile->getTypes());
            echo $form->error($importFile,'type');
            ?>
        </div>
        <div class="fluidField">
            <?php
        ...
        <div class="fluidField">
            <?php
            echo $form->labelEx($importFile,'file_path');
            echo $form->textField($importFile,'file_path');
            echo $form->error($importFile,'file_path');
            ?>
        </div>
        <div class="fluidField">
            <?php
