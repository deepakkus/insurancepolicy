...
<script type="text/javascript">
    ...
    var triageZoneAreas = <?php echo isset($resTriageZoneAreas) ? json_encode($resTriageZoneAreas) : json_encode(array()); ?>;
    var editableLayers = new L.FeatureGroup();
    editableLayers.type = 'draw';
    editableLayers.addTo(map);

    var fullscreenControl = new L.Control.Fullscreen().addTo(map);
    var triageControl = new L.Control.TriageControl(triageZoneAreas, editableLayers).addTo(map);
