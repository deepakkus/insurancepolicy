...
class XUpload extends CJuiInputWidget {
    ...
    public function run() {
        ...
        if ($this -> downloadTemplate === null) {
            ...
            $this -> render("download", array('assessment_id'=> $model->id));
        }
        ...
        $this -> render("form", array('htmlOptions'=>$htmlOptions, 'name'=>$name, 'model'=>$model));
    }
    ...
    public function publishAssets() {
        ...
        if (is_dir($assets)) {
            ...
            //Yii::app() -> clientScript -> registerCssFile('http://blueimp.github.com/cdn/css/bootstrap.min.css');
            ...
            Yii::app() -> clientScript -> registerScriptFile($baseUrl . '/js/load-image.min.js', CClientScript::POS_HEAD);
            /**
